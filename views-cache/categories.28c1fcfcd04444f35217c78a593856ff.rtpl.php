            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td> <!--Chave/Valor-->
                    <td><?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td> <!--Chave/Valor-->
                    <td>
